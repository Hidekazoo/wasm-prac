            ...
            pub mod run {
                ...
                macro_rules! __export_wasi_cli_run_0_2_7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        "wasi:cli/run@0.2.7#run")] unsafe extern "C" fn export_run() ->
...
macro_rules! __export_example_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        exports::wasi::cli::run::__export_wasi_cli_run_0_2_7_cabi!($ty with_types_in
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:sample:example:encoded world"
)]
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x01B\x03\x01j\0\0\x01@\0\0\0\x04\0\x03run\x01\x01\
\x04\0\x12wasi:cli/run@0.2.7\x05\x01\x04\0\x18component:sample/example\x04\0\x0b\

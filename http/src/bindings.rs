...
pub unsafe fn _export_sample_request_cabi<T: Guest>() -> *mut u8 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let result0 = T::sample_request();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_sample_request<T: Guest>(arg0: *mut u8) {
...
pub trait Guest {
    fn sample_request() -> Result<_rt::String, _rt::String>;
}
#[doc(hidden)]
macro_rules! __export_world_example_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "sample-request")] unsafe extern "C" fn
        export_sample_request() -> * mut u8 { unsafe { $($path_to_types)*::
        _export_sample_request_cabi::<$ty > () } } #[unsafe (export_name =
        "cabi_post_sample-request")] unsafe extern "C" fn
        _post_return_sample_request(arg0 : * mut u8,) { unsafe { $($path_to_types)*::
        __post_return_sample_request::<$ty > (arg0) } } };
    };
}
#[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:http:example:encoded world"
)]
#[doc(hidden)]
...
j\x01s\x01s\x01@\0\0\0\x04\0\x0esample-request\x01\x01\x04\0\x16component:http/e\
